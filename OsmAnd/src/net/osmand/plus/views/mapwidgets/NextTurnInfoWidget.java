...
//					turnType.getExitOut() + "");
	...
	public void setTurnImminent(int turnImminent, boolean deviatedFromRoute, int nextTurnDistance, int minDistanceForTurn) {
		if(turnDrawable.turnImminent != turnImminent || turnDrawable.deviatedFromRoute != deviatedFromRoute) {
			turnDrawable.setTurnImminent(turnImminent, deviatedFromRoute,  nextTurnDistance,  minDistanceForTurn);
		}
	}
	...
	public static class TurnDrawable extends Drawable {
		...
		public void setTurnImminent(int turnImminent, boolean deviatedFromRoute, int nextTurnDistance, int minDistanceForTurn) {
			...
			if (deviatedFromRoute){
				...
				//si es nextTurnDistance < minDistanceForTurn
if (nextTurnDistance < minDistanceForTurn){
